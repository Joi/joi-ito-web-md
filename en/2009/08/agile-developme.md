---
title: "Agile development, startups and government policy"
date: 2009-08-11T00:00:00
permalink: https://joi.ito.com/weblog/2009/08/11/agile-developme.html
language: en
categories: []
author: Joichi Ito
source_path: /weblog/2009/08/11/agile-developme.html
extracted: 2025-12-25
---

When I visited Chicago last, [John Bracken](http://bracken.wordpress.com/) and [Brian Fitzpatrick](http://www.red-bean.com/fitz/) aka Fitz from Google organized a very interesting meeting with people from [The MacArthur Foundation](http://www.macfound.org/), Google and various communities including some folks involved in government.

During the meeting, I talked a lot about my thoughts on innovation in the context of newer software development practices and frameworks like [agile development](http://en.wikipedia.org/wiki/Agile_development) and Ruby on Rails. As Reid Hoffman often says, if you're not embarrassed by your the first release of your product, you've released too late." The release early, release often ethos of linux combined with the amount of actual "real work" you can do in one week with Ruby on Rails and other languages and frameworks totally changes the game for early stage consumer Internet investing.
...
A lot of my thinking in this area has come from watching [Jay Dvivedi and his team at Shinsei Bank](http://www.iitk.ac.in/infocell/announce/ITM/strategic.html) and also working a a little with the [Pivotal Labs](http://pivotallabs.com/) folks. Having written this rambling blog post, I'd still like to say that I'm still rather new to the whole world of agile development, but I think there are a large number of practices that are being developed that can be applied to many other fields including but not limited to government policy development.